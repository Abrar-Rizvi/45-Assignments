...
let age = 20;
console.log("Is age == 20 ? i would like to predict true.");
...
console.log(myWatch == "old"); //False

let car2 = "Toyota";
console.log('Is car2 == "Honda" ? I would like to predict False');
console.log(car2 == "Honda"); //False

let fan = "consuming electricity";
console.log('Is fan !== "consuming electricity" ? I predict False');
console.log(fan !== "consuming electricity"); //false
